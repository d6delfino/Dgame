...
function updateSetupUI() {
    ...
    if (confirmBtn) {
        ...
        // Impostiamo l'altezza e l'allineamento a sinistra
        ...
        confirmBtn.innerHTML = `<span style="font-size:1.4em; vertical-align:middle; line-height:1; margin-right: 10px;">▶️</span> PRONTO`;
    }
    ...
    confirmBtn.style.minHeight = 'auto';
    confirmBtn.style.textAlign = 'left';          // ← sposta il contenuto a sinistra
...
function renderAgentMarket() {
    ...
    setupData.agents.forEach((agent, index) => {
        ...
        spriteWrap.style.cssText = 'display:flex;align-items:center;justify-content:center;cursor:pointer;overflow:visible;pointer-events:auto;';
        ...
        prevBtn.style.cssText = arrowBtnStyle + 'left:0;';
        prevBtn.innerHTML = '&#8249;';
        prevBtn.onclick = (e) => {
            e.stopPropagation();
        ...
        nextBtn.style.cssText = arrowBtnStyle + 'right:0;';
        nextBtn.innerHTML = '&#8250;';
        nextBtn.onclick = (e) => {
            e.stopPropagation();
            const cur = parseInt(agent.customSpriteId.replace(prefix, '')) || 1;
        ...
        // Colonna destra: 4 stat impilate verticalmente
        const statTypes = [
        ...
        statTypes.forEach(stat => {
            ...
            item.style.cssText = `
                ...
                padding:3px 8px; gap:8px; width:130px; box-sizing:border-box;
            `;
            item.innerHTML = `
                <span style="font-size:11px;text-transform:uppercase;color:#888;width:36px;flex-shrink:0;">${stat.label}</span>
