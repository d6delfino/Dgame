...
async function initDeepAI() {
    ...
    try {
        ...
        console.warn("⚠️ DeepAI disabilitata. Il sistema userà l'AI scriptata (ai.js).");
        deepAI = null; // Forza null per disabilitare il bridge
    }
}
...
markScriptAsLoaded('ai_bridge.js');