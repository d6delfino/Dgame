...
const CAMPAIGN = {
    ...
    UPGRADE_MINEFIELD_COST: 10,   // costo Campo Minato (ferma l'attaccante)
...
const FACTION_PREFIXES = {
    1: { prefix: 'EUR', count: 4 }, // Verdi
    2: { prefix: 'ZER', count: 4 }, // Viola
    3: { prefix: 'MED', count: 4 }, // Blu
    4: { prefix: 'GUA', count: 4 }, // Oro
    5: { prefix: 'DEM', count: 16 }, // Rossi
    6: { prefix: 'ALI', count: 4 }, // Bianchi
    7: { prefix: 'ROB', count: 4 }, // Grigi
    8: { prefix: 'UNI', count: 4 }  // Rosa
};

const _FACTION_DEFS = [
    { slot: 1, name: 'Verde',  color: COLORS.p1 },
    { slot: 2, name: 'Viola',  color: COLORS.p2 },
    { slot: 3, name: 'Blu',    color: COLORS.p3 },
    { slot: 4, name: 'Oro',    color: COLORS.p4 },
    { slot: 5, name: 'Rosso',  color: COLORS.p5 },
    { slot: 6, name: 'Bianco', color: COLORS.p6 },
    { slot: 7, name: 'Grigio', color: COLORS.p7 },
    { slot: 8, name: 'Rosa',   color: COLORS.p8 },
];
