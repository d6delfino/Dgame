...
function _renderRecruitSection(panel, pData, credits, color) {
    ...
    // Cambiato space-between in flex-start e aggiunto un gap di 25px per distanziarli bene
    footer.style.cssText = `display:flex; justify-content:flex-start; align-items:center; gap:25px; margin-top:auto;`;
    footer.innerHTML = `
