...
function _renderRecruitSection(panel, pData, credits, color) {
    ...
    statTypes.forEach(stat => {
        ...
        // Usiamo un layout orizzontale fisso [-] [val] [+] che non salta mai
        item.style.cssText = `display:flex; align-items:center; background:#0a0a10; border:1px solid #333; padding:4px 6px; border-radius:4px; gap:4px; flex-shrink:0;`;
        item.innerHTML = `
