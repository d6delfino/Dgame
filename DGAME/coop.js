...
function showCoopMenu() {
    ...
    block.style.cssText = 'margin-top:0px; text-align:center;'; // Azzerato margin esterno
    block.innerHTML = `
    <div style="border-top:1px solid #333; padding-top:15px; margin-top:15px;">
<p style="color:#a0a0b0; margin-bottom:15px; font-size: 18px; line-height: 0.8; text-transform: uppercase; letter-spacing:1px;">
            <span style="display:inline-block; width:0; height:0; overflow:visible; position:relative;"><img src="img/coop.png" style="height:3.5em; position:absolute; top:-0.9em; left:-4em; transform:translateY(-50%); pointer-events:none;"></span><span style="margin-left:2.8em;"> cooperativa</span>
        </p>
