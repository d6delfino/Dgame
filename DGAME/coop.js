...
function showCoopMenu() {
    ...
    <div style="border-top:1px solid #333; padding-top:20px; margin-top:15px;">
        <p style="color:#a0a0b0; margin-bottom:15px; font-size:13px; text-transform:uppercase; letter-spacing:1px;">
            <span style="font-size:2em; vertical-align:middle;">👾</span> cooperativa
        </p>
        <div style="display:flex; gap:10px; justify-content:center; flex-wrap:wrap;">
            ${[1,2,3,4].map(n => `
                <button class="action-btn" onclick="startCoopGame(${n})"
                style="padding:10px 18px; border:2px solid #00aaff; color:#00aaff; cursor:pointer; background:rgba(0,170,255,0.08); border-radius:12px; box-shadow:0 0 10px #00aaff inset, 0 0 20px #00aaff, 0 0 45px #00aaff99;">
                ${n}P COOP
                </button>
                `).join('')}
            </div>
