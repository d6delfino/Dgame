...
function resetTurnState() {
    ...
    if (turnCount === 1) {                                                    // ← AGGIUNGI
        players[currentPlayer].agents.forEach(a => { a.firstTurnImmune = false; });  // ← AGGIUNGI
        if (players[currentPlayer].hq) players[currentPlayer].hq.firstTurnImmune = false;  // ← AGGIUNGI
    }  
