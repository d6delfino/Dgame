...
function updateUI() {
    ...
    // CARTE: aggiorna il pannello carte in-game
...
function executeRemoteAction(data) {
    ...
    // card_airdrop e card_build non richiedono validActionTargets: executeAction
    // li gestisce direttamente nel ramo fromNetwork=true (carduse.js override)
