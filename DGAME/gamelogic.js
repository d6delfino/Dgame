...
function showGameOverlay(title, message, color) {
    ...
    if (hqId) {
        ...
        // STILE AGGIORNATO: Altezza triplicata (16.5em) e limiti per schermi piccoli
        img.style.cssText = `
            height: 16.5em; 
            max-height: 40vh; 
            width: auto; 
        ...
        // Se l'immagine non esiste o non si carica, usa l'emoji di fallback
        img.onerror = () => {
        ...
        // Fallback di sicurezza se per qualche motivo non troviamo la fazione
        icon.innerHTML = '<span style="font-size:8em;">🏆</span>';
    }
