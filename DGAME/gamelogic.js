...
function initTimerUI() {
    ...
    timerUI.innerHTML = `
        ...
        <div id="round-number" style="font-size:12px; color:#aaa;">ROUND 1</div>
        <div id="turn-hint" style="font-size:10px; opacity:0.7; font-style:italic; margin-top:2px;">passa turno</div>
    `;
