        ...
        if (isOnline && !fromNetwork) {
            sendOnlineMessage({
                ...
                agentBuffs: {
                    ...
                    // FIX MULTIPLAYER: Aggiunta sincronizzazione Gittata per evitare NaN a fine turno
                    rng:            selectedAgent.rng,
                    originalRng:    selectedAgent.originalRng   || selectedAgent.rng,
                    // FIX MULTIPLAYER: Aggiunta sincronizzazione Mov/MaxHp/MedikitTempBuff
                    // (stesso motivo di dmg/rng sopra: senza questi campi il client remoto
                    // può disallinearsi dall'host sul reset di fine turno del MediBuff C09)
