...
const CAMPAIGN_UPGRADE_DEFS = [
    ...
    { key: 'fortressUpgrade',  icon: '🏰', name: 'Fortezza',         cost: () => CAMPAIGN.UPGRADE_FORTRESS_COST,  desc: 'Annulla gli attacchi di artiglieria sul settore. Rendita: -3.' },
...
function _applySectorUpgradeLocale(playerFaction, sectorId, upgradeKey, cost) {
    ...
    if(upgradeKey === 'fortressUpgrade') sector.income = (sector.income || 1) - 3;
...
function _isSectorReachable(targetId, p) {
    ...
    // Gittata massima: 2 base + bonus Hangar
    let maxDist = 2;
