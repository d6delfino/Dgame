...
const CAMPAIGN_UPGRADE_DEFS = [
    ...
    { key: 'infiltratiUpgrade', icon: '🕵️', name: 'Infiltrati',      cost: () => CAMPAIGN.UPGRADE_INFILTRATI_COST, desc: 'Permette un attacco a qualsiasi settore sulla mappa. Effetto unico.' }
];
