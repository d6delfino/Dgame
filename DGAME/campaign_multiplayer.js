...
function _hostApplyInfiltratiAttack(targetSectorId, credits, fromPlayer) {
    ...
    // Registra l'ordine di attacco normalmente
...
function _applySnapshot(snap) {
    ...
    if (snap.playersMeta && typeof players !== 'undefined') { // rimosso "window." e usato typeof
        Object.entries(snap.playersMeta).forEach(([p, meta]) => {
            const pNum = Number(p);
            if (!players[pNum]) players[pNum] = {}; // rimossi tutti i "window."
