...
const CARD_DEFINITIONS = {
    ...
    C09: {
      ...
      apply(faction) {
        // Se hai selezionato l'HQ, forziamo il bersaglio sull'HQ.
        // Altrimenti usiamo il sistema di auto-mira per curare l'agente alleato più vicino.
        const target = (selectedAgent.type === 'hq') 
                       ? selectedAgent 
                       : (_getMostDamagedAdjacentAlly(selectedAgent) || selectedAgent);
