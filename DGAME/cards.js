...
const CARD_DEFINITIONS = {
    ...
    C03: {
        ...
        needsAgent: true,
        description: 'Raddoppia la gittata base. Lo sparo danneggia ed attraversa il primo bersaglio, colpendo anche quello successivo.',
        apply(faction) {
    ...
    C04: {
        ...
        apply(faction) {
            ...
            // Se l'agente è GIA' ferito, facciamo scattare il Medikit in automatico dopo un breve ritardo
