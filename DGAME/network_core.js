...
function updateHostLobby() {
    ...
    if (coopBtn) {
        ...
        coopBtn.style.borderColor = coopReady ? '#a0ff00' : '#555';
        coopBtn.style.color       = coopReady ? '#a0ff00' : '#555';
        coopBtn.style.cursor      = coopReady ? 'pointer' : 'not-allowed';
        coopBtn.style.background  = coopReady ? 'rgba(160,255,0,0.08)' : 'transparent';
