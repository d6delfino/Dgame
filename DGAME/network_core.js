...
overlay.innerHTML = `
    <div style="width: 100%; max-width: 450px; padding: 20px; box-sizing: border-box; text-align: center;">
        ...
        <div id="faction-buttons-container" style="display:grid; grid-template-columns: 1fr 1fr; gap:10px; width: 100%;">
            ${buttonsHtml}
        </div>
        <p id="color-picker-instruction" style="color:#666; margin-top:20px; font-size:12px; line-height:1.4;">
            L'host deve confermare la tua scelta
        </p>
    </div>
`;
