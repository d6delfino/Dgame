...
function renderHostPanel(id) {
    ...
    panel.innerHTML = `
        ...
        <button class="action-btn" id="btn-start-coop-online" onclick="hostStartOnlineCoop()"
            ...
            <span style="font-size:2em; line-height:1; display:inline-block; margin-top:-0.25em; margin-bottom:-0.25em; position:relative; top:4px;">👾</span> AVVIA COOP
        </button>
...
function updateHostLobby() {
    ...
    if (coopBtn) {
        ...
        if (hasBots) {
            coopBtn.innerText = '👾 COOP NON SUPPORTA BOT';
            coopBtn.style.fontSize = '11px'; 
        } else {
            coopBtn.innerHTML = '<span style="font-size:2em; line-height:1; display:inline-block; margin-top:-0.25em; margin-bottom:-0.25em; position:relative; top:4px;">👾</span> AVVIA COOP';
