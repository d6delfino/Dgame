...
function renderHostPanel(id) {
    ...
    panel.innerHTML = `
        ...
        <span style="margin-left:2.2em; position:relative; z-index:1;">AVVIA BATTAGLIA</span>
         </button>
        ...
        <span style="margin-left:2.2em; position:relative; z-index:1;">AVVIA CAMPAGNA</span>
          </button>
        </div>
        <button class="action-btn" id="btn-start-coop-online" onclick="hostStartOnlineCoop()"
            ...
            <span style="margin-left:3.4em;"> AVVIA COOP</span>
        </button>
    ...
    if (coopBtn) {
        ...
        if (hasBots) {
            ...
            coopBtn.innerHTML = `
                ...
                <span style="margin-left:3.4em; position:relative; z-index:1;"> AVVIA COOP</span>`;
