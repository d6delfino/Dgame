...
function showOnlineColorPicker() {
    ...
    overlay.innerHTML = `
        <div style="width: 100%; max-width: 450px; padding: 25px; box-sizing: border-box; text-align: center; background: rgba(10, 10, 20, 0.6); backdrop-filter: blur(10px); border: 1px solid rgba(255,255,255,0.1); border-radius: 12px; box-shadow: 0 0 40px rgba(0,0,0,0.8);">
