...
function updateHostLobby() {
    ...
    // AGGIUNGI QUESTO BLOCCO PER LA COOP:
    ...
    if (coopBtn) {
        ...
        // La Coop è pronta solo se gli umani sono pronti (allReady) 
        // E NON ci sono bot ( !hasBots )
        ...
        // Cambia il testo del pulsante dinamicamente per spiegare perché è bloccato
        if (hasBots) {
            coopBtn.innerText = '👾 COOP NON SUPPORTA BOT';
            coopBtn.style.fontSize = '11px'; // Testo più piccolo per farlo stare nel tasto
        } else {
