    ...
    panel.innerHTML = `
        ...
        <div style="display:flex; gap:8px; margin-top:0;">
            <button class="action-btn" id="btn-start-online" onclick="hostStartGame()"
                ...
                <span style="font-size:3.5em; position:absolute; top:-0.8em; left:-0.6em; pointer-events:none; ">⚔️</span>
                </span>
                <span style="margin-left:2.2em;">AVVIA BATTAGLIA</span>
            </button>
            <button class="action-btn" id="btn-start-campaign-online" onclick="hostStartOnlineCampaign()"
                style="flex:1; padding:14px 6px; border:2px solid #555; color:#555; background:transparent; cursor:not-allowed; font-size:13px; font-weight:bold;" disabled>
                <span style="display:inline-block; width:0; height:0; overflow:visible; position:relative;">
                <span style="font-size:3.5em; position:absolute; top:-1.2em; left:-1.1em; pointer-events:none; opacity:0.6;">🗺️</span>
                </span>
                <span style="margin-left:2.2em;">AVVIA CAMPAGNA</span>
            </button>
            </div>
...
function updateHostLobby() {
    ...
    if (campBtn) {
        ...
        if (hasBots) {
            campBtn.innerText = '🗺️ CAMPAGNA NON SUPPORTA BOT';
            campBtn.style.fontSize = '10px'; // Testo più piccolo per farlo stare nel tasto
        } else {
            campBtn.innerHTML = `
                <span style="display:inline-block; width:0; height:0; overflow:visible; position:relative;">
                <span style="font-size:3.5em; position:absolute; top:-0.8em; left:-0.7em; pointer-events:none; ">🗺️</span>
                </span>
                <span style="margin-left:2.2em;">AVVIA CAMPAGNA</span>`;
    ...
    if (coopBtn) {
        ...
        if (hasBots) {
            coopBtn.innerHTML = '<span style="display:inline-block; width:0; height:0; overflow:visible; position:relative;"><img src="img/coop.png" style="height:3.6em; position:absolute; top:50%; left:-2em; transform:translateY(-50%); pointer-events:none;"></span><span style="margin-left:2.8em;"> COOP NON SUPPORTA BOT</span>';
            coopBtn.style.fontSize = '11px'; 
        } else {
            coopBtn.innerHTML = `
                <span style="display:inline-block; width:0; height:0; overflow:visible; position:relative;">
                <img src="img/coop.png" style="height:4.8em; position:absolute; top:-2.5em; left:-4em; pointer-events:none;">
                </span>
                <span style="margin-left:3.4em;"> AVVIA COOP</span>`;
