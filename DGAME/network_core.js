    ...
    panel.innerHTML = `
        ...
        <div style="display:flex; gap:8px; margin-top:0;">
            <button class="action-btn" id="btn-start-online" onclick="hostStartGame()"
                ...
                <span style="font-size:2em; line-height:1; display:inline-block; margin-top:-0.25em; margin-bottom:-0.25em; position:relative; top:4px;">⚔️</span> AVVIA BATTAGLIA
            </button>
            <button class="action-btn" id="btn-start-campaign-online" onclick="hostStartOnlineCampaign()"
                style="flex:1; padding:14px 6px; border:2px solid #555; color:#555; background:transparent; cursor:not-allowed; font-size:13px; font-weight:bold;" disabled>
                <span style="font-size:2em; line-height:1; display:inline-block; margin-top:-0.25em; margin-bottom:-0.25em; position:relative; top:4px;">🗺️</span> AVVIA CAMPAGNA
            </button>
            </div>
        <button class="action-btn" id="btn-start-coop-online" onclick="hostStartOnlineCoop()"
            ...
            <span style="display:inline-block; width:0; height:0; overflow:visible; position:relative;"><img src="img/coop.png" style="height:3.6em; position:absolute; top:50%; left:-2em; transform:translateY(-50%); pointer-events:none;"></span><span style="margin-left:2.8em;"> AVVIA COOP</span>
        </button>
...
function updateHostLobby() {
    ...
    if (campBtn) {
        ...
        if (hasBots) {
            ...
            campBtn.innerHTML = '<span style="font-size:2em; line-height:1; display:inline-block; margin-top:-0.25em; margin-bottom:-0.25em; position:relative; top:4px;">🗺️</span> AVVIA CAMPAGNA';
    ...
    if (coopBtn) {
        ...
        if (hasBots) {
            ...
            coopBtn.innerHTML = '<span style="display:inline-block; width:0; height:0; overflow:visible; position:relative;"><img src="img/coop.png" style="height:3.6em; position:absolute; top:50%; left:-2em; transform:translateY(-50%); pointer-events:none;"></span><span style="margin-left:2.8em;"> AVVIA COOP</span>';
